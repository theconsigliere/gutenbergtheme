...
<div id="<?php echo esc_attr($id); ?>" class="hero-collage <?php echo esc_attr($className); ?>"
    data-hero='<?php echo esc_attr($className); ?>' style='background-color: <?php echo $background_color; ?>'>
